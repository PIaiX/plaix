            ...
            <Container>
                ...
                <section className="sec-home-2-new" id="uslugy">
                    <h2 className="text-center">
                        {t("Приступим")} <span ref={objRef} className="indicator-switch" data-observing={isVisible}><span></span></span> {t("к вашему проекту уже завтра")}
                    </h2>
                    ...
                    <Swiper
                        ...
                        <SwiperSlide>
                            <div className="card-1">
                                <h4 className="fw-4">{t("Lorem ipsum")}</h4>
