  ...
  return (
    <svg className={props.className} preserveAspectRatio="xMaxYMidslice" width={(mobile)?"550":"1780"} height={(mobile)?"440":"800"} viewBox={(mobile)?"0 0 350 440":"0 0 1780 800"} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g filter="url(#filter1)">
        <ellipse className='ellipse-1' cx="10%" cy="200%" rx="24%" ry="42%"/>
      </g>
      {/* Green 1 */}
      <g filter="url(#filter2)">
        <ellipse className='ellipse-2' cx="115%" cy="113%" rx="24%" ry="42%"/>
      </g>
      {/* Blue 2 */}
      <g filter="url(#filter3)">
        <ellipse className='ellipse-3' cx="-6%" cy="-20%" rx="24%" ry="42%"/>
      </g>
      {/* Green 2 */}
      <g filter="url(#filter4)">
        <ellipse className='ellipse-4' cx="20%" cy="140%" rx="20%" ry="35%"/>
      </g>
      <defs>
        {/* Blue 1 */}
